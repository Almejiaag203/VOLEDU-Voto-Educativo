<!-- [ Layout footer ] Start -->
                    <nav class="layout-footer footer bg-white">
                        <div class="container-fluid d-flex flex-wrap justify-content-between text-center container-p-x pb-3">
                            <div class="pt-3">
                                <span class="footer-text font-weight-semibold"> Copyright &copy; <a href="https://www.facebook.com/TechFusionData" class="footer-link" target="_blank">TehFusion Data</a></span>
                            </div>
                            <div>
    ...
    <!-- Incluir SweetAlert2 y el script personalizado -->
