...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-0">GESTIÓN DE ESTUDIANTES - SECUNDARIA</h4>
        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item">Estudiantes Secundaria</li>
            </ol>
        </div>
        ...
        <div class="mb-4">
            <button class="btn btn-primary" data-toggle="modal" data-target="#registrarEstudianteModal">
                <i class="feather icon-plus"></i> Registrar Estudiante Secundaria
            </button>
        </div>

        <!-- Tabla para mostrar estudiantes -->
        <div class="card">
            <h6 class="card-header">Lista de Estudiantes Secundaria</h6>
            <div class="card-body">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content border-0 shadow-lg" style="border-radius: 10px;">
                    <div class="modal-header bg-primary text-white" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <h5 class="modal-title" id="registrarEstudianteModalLabel">Registrar Nuevo Estudiante Secundaria</h5>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content border-0 shadow-lg" style="border-radius: 10px;">
                    <div class="modal-header bg-info text-white" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                        <h5 class="modal-title" id="editarEstudianteModalLabel">Editar Estudiante Secundaria</h5>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    function loadEstudiantes(page = 1) {
        ...
        fetch('controllers/Estudiante_controles.php', {
            ...
            body: new URLSearchParams({
                ...
                page: page,
                limit: limit,
                nivel: 'Secundaria'  // Filtro por nivel Secundaria
            })
        })
